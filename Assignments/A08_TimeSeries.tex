...
\begin{Highlighting}[]
\CommentTok{# 2 }
\NormalTok{GaringerOzone}\FloatTok{.10}\NormalTok{<-}\KeywordTok{rbind}\NormalTok{(GaringerOzone2012010, GaringerOzone2012011, GaringerOzone2012012, GaringerOzone2012013, GaringerOzone2012014, GaringerOzone2012015, GaringerOzone2012016, GaringerOzone2012017, GaringerOzone2012018, GaringerOzone2012019)}


\CommentTok{# 3}
\NormalTok{GaringerOzone}\FloatTok{.10}\OperatorTok{$}\NormalTok{Date<-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(GaringerOzone}\FloatTok{.10}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%Y"}\NormalTok{)}

\CommentTok{# 4}
\NormalTok{GaringerOzone.Wrangled<-}\StringTok{ }\KeywordTok{select}\NormalTok{(GaringerOzone}\FloatTok{.10}\NormalTok{, Date, Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration, DAILY_AQI_VALUE)}
...
\CommentTok{# 6}
\CommentTok{#specify 3652 rows and 3 columns.}
\CommentTok{#left_join(x,y)}
\NormalTok{GaringerOzone<-}\StringTok{ }\KeywordTok{left_join}\NormalTok{(Days, GaringerOzone.Wrangled)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#put days first because Rows in x with no match in y will have NA values in the new columns.}
\end{Highlighting}
\end{Shaded}
...
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{MeanOzone =} \KeywordTok{mean}\NormalTok{(Daily.Max.}\FloatTok{8.}\NormalTok{hour.Ozone.Concentration))}

\NormalTok{GaringerOzone.Monthly}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\KeywordTok{paste}\NormalTok{(GaringerOzone.Monthly}\OperatorTok{$}\NormalTok{Year,GaringerOzone.Monthly}\OperatorTok{$}\NormalTok{Month, }
                                                \DecValTok{1}\NormalTok{, }\DataTypeTok{sep=}\StringTok{"-"}\NormalTok{), }
                                          \DataTypeTok{format =} \StringTok{"%Y-%m-%d"}\NormalTok{)}
  
\CommentTok{# 10}
\CommentTok{#Generate a time series called GaringerOzone.monthly.ts, with a monthly frequency that specifies the correct start and end dates. }
...
\CommentTok{# 11}
\CommentTok{#Run a time series analysis. In this case the seasonal Mann-Kendall is most appropriate; why is this?}
\NormalTok{GaringerOzone.Monthly.ts.trend <-}\StringTok{ }\KeywordTok{smk.test}\NormalTok{(GaringerOzone.Monthly.ts)}
\NormalTok{GaringerOzone.Monthly.ts.trend}
\end{Highlighting}
\end{Shaded}
