...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ChemPhys <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv"}\NormalTok{)}
...
\begin{Highlighting}[]
\CommentTok{#3}
\NormalTok{ChemPhys.Wrangled <-}\StringTok{ }
\StringTok{  }\NormalTok{ChemPhys  }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(lakename, year4, daynum, depth, temperature_C) }\OperatorTok{%>%}
\StringTok{  }\CommentTok{#filter for Julian days in July and surface measurements}
...
\CommentTok{#4}
\NormalTok{ChemPhys.TempAIC <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ ChemPhys.Wrangled, temperature_C }\OperatorTok{~}\StringTok{ }\NormalTok{year4 }\OperatorTok{+}\StringTok{ }\NormalTok{daynum }\OperatorTok{+}\StringTok{ }\NormalTok{depth) }
\KeywordTok{step}\NormalTok{(ChemPhys.TempAIC)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#6}
\NormalTok{ChemPhys.TempANCOVA <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ ChemPhys.Wrangled, temperature_C }\OperatorTok{~}\StringTok{ }\NormalTok{depth }\OperatorTok{*}\StringTok{ }\NormalTok{lakename) }
\KeywordTok{summary}\NormalTok{(ChemPhys.TempANCOVA)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#8}
\NormalTok{Temp.depthplot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(ChemPhys.Wrangled, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ depth, }\DataTypeTok{y =}\NormalTok{ temperature_C, }\DataTypeTok{color =}\NormalTok{ lakename)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha=}\FloatTok{0.4}\NormalTok{, }\DataTypeTok{shape=}\DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }
...
\KeywordTok{print}\NormalTok{(Temp.depthplot)}
\end{Highlighting}
\end{Shaded}
