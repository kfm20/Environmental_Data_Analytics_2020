...
# add your code here
NC<- southeast_state_bounds %>% filter(NAME== "NC")%>%
...
NC_basins_nf_seplains<-basins_nf_seplains%>%
  st_intersection(NC) #intersection same as clip in ARCGIS
# check
# add your code here
...
# bonus
# add your code here
NC_area<-st_area(NC) #area of VA
NC_area

NC_centroid<-st_centroid(NC)#find centroid of VA
NC_centroid

ncbuffer<-st_buffer(NC_gages, dist=100) #buffer around stream gages in VA

not_nc_gages<- st_difference(gages, NC) #stream gages not in VA
```
