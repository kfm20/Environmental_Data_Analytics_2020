...
> Answer: The mixed effects model is a better model based on the anova between the two modesl, mixed effects has a lower AIC.The pvalue tells us whether they have a significantly different fit, and the resultant pvalue from the anova says__****