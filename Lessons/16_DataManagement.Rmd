...
> In order for any data to be valid, published, or used in any fomral setting, it needs to be properly managed, allowing the data to be reproducible. Quality assurance, quality control to back data, identify any erros, etc.. Well commented code is important when you go back through to explain what you did with the data, or if you have to back back through and make edits
